...
var L;
async function T() {
  if (!g || (z = (await import("./node_url-6BIV7MYO.js")).default, H = await import("./node_fs-KP4XMRG4.js"), L = await import("./promises-ELCTGSBO.js"), V = (await import("./node_vm-WNE7DBMI.js")).default, D = await import("./node_path-P3ZF5MV7.js"), U = D.sep, typeof I < "u")) return;
  let e = H, t = await import("./node_crypto-OPYK4ANM.js"), o = await import("./ws-MVPV7GAM.js"), r = await import("./node_child_process-OFKKVJQV.js"), a = { fs: e, crypto: t, ws: o, child_process: r };
...
s(q, "loadBinaryFile");
var F;
if ($) F = s(async (e) => await import(e), "loadScript");
else if (j) F = s(async (e) => {
  try {
...
async function K() {
  ...
  if (g && !t.startsWith("file://") && (t = `file://${t}`), W) {
    let r = await import("./node_path-P3ZF5MV7.js");
    return (await import("./node_url-6BIV7MYO.js")).fileURLToPath(r.dirname(t));
  }
...
function Y(e) {
  let t = e.FS, o = e.FS.filesystems.MEMFS, r = e.PATH, a = { DIR_MODE: 16895, FILE_MODE: 33279, mount: function(n) {
    ...
    for (let [l, d] of c) l !== "." && (i[r.join2(n.mountpoint, l)] = { timestamp: d.kind === "file" ? (await d.getFile()).lastModifiedDate : /* @__PURE__ */ new Date(), mode: d.kind === "file" ? a.FILE_MODE : a.DIR_MODE });
